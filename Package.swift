...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-1.4.26.xcframework.zip",
			checksum: "acc467b7c51342a4625c85784dba5f6ce2d1a2984e837e85b60b87d968733d64"
		)
	]
)