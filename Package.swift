...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.2.0-beta.21.xcframework.zip",
			checksum: "b56b487937bf7b97920d8b44da0cfafc6528843cb11edc09936bb3f4dff28d7b"
		)
	]
)