...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.2.0-beta.25.xcframework.zip",
			checksum: "b5dce1be6288e2a587ab2f08f42fa853864d13f2852d479094a42641e2afee7d"
		)
	]
)