...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta+20230420132651.xcframework.zip",
			checksum: "3fb941b9d28e32755d6ba4c143099fa60abf2a02ef6798e8206eb8ef3d70e424"
		)
	]
)