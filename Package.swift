...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-2.0.17.xcframework.zip",
			checksum: "f07b1703a31a4a2402ae45bf07638a508fcce011469a58c31e388e2d97b8d5da"
		)
	]
)