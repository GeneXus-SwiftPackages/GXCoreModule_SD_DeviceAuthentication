...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-4.0.4.xcframework.zip",
			checksum: "f1064eaf4fb047e163f5d8e8845c68173f3857175f510067304e2888a31e531a"
		)
	]
)