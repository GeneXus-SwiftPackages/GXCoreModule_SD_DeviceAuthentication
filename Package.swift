...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.1.0-beta.8.xcframework.zip",
			checksum: "6f67251ac59d4592030def6b74be2fe94c1b31f1befb7e26c55b1412f84b2f3e"
		)
	]
)