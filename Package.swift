...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "74caa98abda110f074596486114f416850e6c045bfaeddd1edc6bfb7081e6f97"
		)
	]
)