...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.34.xcframework.zip",
			checksum: "03cfe6e9b1b98daeaf18611af9a2ec80e89cf5bdc6dbdaf5b4e656464853e230"
		)
	]
)