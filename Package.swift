...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.4.0-beta.11.xcframework.zip",
			checksum: "176f6cb5960587aeb212f9bbc6979c2a36d2275c5593deecd894a1caf56df2fc"
		)
	]
)