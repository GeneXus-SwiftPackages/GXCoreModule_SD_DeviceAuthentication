...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-1.1.2.xcframework.zip",
			checksum: "23e7c2de5032076d4e26d8f10361296186087dbf553b7c6d217387c8fe3c7ed4"
		)
	]
)