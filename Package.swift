...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.19.xcframework.zip",
			checksum: "446832676674cc9affe40d8b5e1e5ee1bebf03dbf6e97bfac617f81b5f1e38df"
		)
	]
)