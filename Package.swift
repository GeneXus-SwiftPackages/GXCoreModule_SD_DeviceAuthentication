...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-2.0.12.xcframework.zip",
			checksum: "a7f7c378d87d837fa26d69b5e8ba9e1aa351a35f27d6f5778409f9f9199bd23b"
		)
	]
)