...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.21.xcframework.zip",
			checksum: "37da25852b79fff47b70e6a005c30a703dab648edae2414af5980e02371c459a"
		)
	]
)