...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-2.1.4.xcframework.zip",
			checksum: "e2381d49b73a984236cbfb3a9ad1cacc0d1e157f330962ad48b0fe6c680fce93"
		)
	]
)