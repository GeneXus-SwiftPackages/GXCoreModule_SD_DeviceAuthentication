...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230701000831.xcframework.zip",
			checksum: "c9d2fc5dc243a37f4fadfda88109e8356dfdf9bdd9f17ab7713d74c9f57c5069"
		)
	]
)