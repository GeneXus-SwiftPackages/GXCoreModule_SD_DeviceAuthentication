...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230711133237.xcframework.zip",
			checksum: "9c19041e127d44db3641eedec256200c5e8f620f1979ee5392758a0f3197460f"
		)
	]
)