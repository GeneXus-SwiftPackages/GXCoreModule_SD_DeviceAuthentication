...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.33.xcframework.zip",
			checksum: "9d09aa8bde95b5b85a16e901843d1173bf67002881d55691cecd3cb319b42a63"
		)
	]
)