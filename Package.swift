...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.38.xcframework.zip",
			checksum: "314b98f0e15e63105eb561bce9c6a5a52c7c03f909856f3653a0d137a13e0744"
		)
	]
)