...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.3.0-beta.6.xcframework.zip",
			checksum: "9ec8654598f3bac56e7b6b969de861c745edc4aef8c71bc62096bbb08e6de47a"
		)
	]
)