...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.4.0-beta.5.xcframework.zip",
			checksum: "f116c190afa91ea77ecbf20dfea3192a8aca7ebf560e807f57992bde7fe5ba43"
		)
	]
)