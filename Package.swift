...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "024091c952a1afc129621111692431984fd92fb2cbc659602708f14e6b0f024c"
		)
	]
)