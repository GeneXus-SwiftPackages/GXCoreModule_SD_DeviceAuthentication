...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.2.0-beta.30.xcframework.zip",
			checksum: "7acc5739da9c545202a3eb935e491df5d556b10ada6518565fb5f1993c725330"
		)
	]
)