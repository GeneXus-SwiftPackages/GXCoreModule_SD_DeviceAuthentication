...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.2.0-beta.24.xcframework.zip",
			checksum: "3f732eec4d793b80b1b25eb39ad000aeeb1b79b509c1df0b82f50b81d7dd9a5e"
		)
	]
)