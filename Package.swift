...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-4.1.0-beta.18.xcframework.zip",
			checksum: "8b66bcac052e15dac8ad195bb50eba808caedfddc8fc42682d84239b1ec17da6"
		)
	]
)