...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.2.0-beta.12.xcframework.zip",
			checksum: "e0e5ca37edf0ee432c52fd0545ebbf5368f68792f3d5dbec8bc070a16701ea9f"
		)
	]
)