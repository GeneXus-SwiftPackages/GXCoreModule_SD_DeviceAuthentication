...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.5.0-beta.27.xcframework.zip",
			checksum: "b587e2c752be51299ecb81cac8e83ec58ad63b0a474d2311f27e911537aef7d0"
		)
	]
)