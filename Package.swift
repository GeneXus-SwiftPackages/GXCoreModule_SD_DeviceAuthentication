...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230615110131.xcframework.zip",
			checksum: "59349a1731dab70d2c6b1c90ccbbd9f5622c2d0d2a36b20546bacf9449e6fc06"
		)
	]
)