...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.4.0-beta.20.xcframework.zip",
			checksum: "04b26454d327141349f5d630bac38ed3a33632c9c7cb70219591a85e6215a7a0"
		)
	]
)