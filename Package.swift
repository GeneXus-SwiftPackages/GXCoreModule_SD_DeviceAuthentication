...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.2.0-beta.1.xcframework.zip",
			checksum: "7af6882f79472f29ff7b9690d2172eb94f22d32e23da0fc19e09b7b5fb1f9157"
		)
	]
)