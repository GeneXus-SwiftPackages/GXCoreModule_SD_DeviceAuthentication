...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.27.xcframework.zip",
			checksum: "08e3060c921f0714721f39c06fd368ae8b8200a928325a651e61f6791064f0b3"
		)
	]
)