...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.2.0-beta.26.xcframework.zip",
			checksum: "2047df6dd6d1bc9bf9d0237c10c4427a991d4ff8934e63c9baafcab90a2c249b"
		)
	]
)