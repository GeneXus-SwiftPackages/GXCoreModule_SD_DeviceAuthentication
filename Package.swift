...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_DeviceAuthentication-1.2.0-rc.1.xcframework.zip",
			checksum: "34af52d3dffc7d47c516d152916fcbdaff4a6a8a3174ad23fb86089d6b4359ea"
		)
	]
)