...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_DeviceAuthentication-1.4.0-rc.1.xcframework.zip",
			checksum: "f13439de645c915cc823e174e4a8e16531086407ecb29b0c75e563525562d915"
		)
	]
)