...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230726144822.xcframework.zip",
			checksum: "bab27563cd948f482eb2ea8208c7959714e636f315b0fa0c2a73986d29ef47bf"
		)
	]
)