...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.2.0-beta.17.xcframework.zip",
			checksum: "88bd9c883a38de79e25ce5f811e9d336914e2863a318e4bdfaa1cbee26a6e2bb"
		)
	]
)