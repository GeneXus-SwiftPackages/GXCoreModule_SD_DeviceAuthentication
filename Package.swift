...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_DeviceAuthentication-1.6.0-rc.0.xcframework.zip",
			checksum: "0cad3fc4e7835f41f2f0a524543061274327020d7342f0045aae0137f596f848"
		)
	]
)