...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.5.0-beta.29.xcframework.zip",
			checksum: "55f6c4cf5d76506cf9e63276756b1edfe70fd7500a8d5bb3df34599a1380a403"
		)
	]
)