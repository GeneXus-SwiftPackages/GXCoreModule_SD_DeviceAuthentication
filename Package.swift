...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_DeviceAuthentication-1.0.0-preview.20230715000002.xcframework.zip",
			checksum: "12812e6c29ae8a48cd06a120c3f917c0eb36f704ff30e94012ef88f2a9343484"
		)
	]
)