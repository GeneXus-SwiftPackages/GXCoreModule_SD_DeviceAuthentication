...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.1.0-beta.12.xcframework.zip",
			checksum: "a69fcbab14c39dcb7df3a872ad18d22b3ef4e3897e1b37df9282a5733c1759e6"
		)
	]
)