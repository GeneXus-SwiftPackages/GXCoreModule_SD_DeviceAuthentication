...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230707201252.xcframework.zip",
			checksum: "fd8b2c556eebe0aebf789c2acb95868b661c823b7a28d743880f26e3dbb4fec9"
		)
	]
)