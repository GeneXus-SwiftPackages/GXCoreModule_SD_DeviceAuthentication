...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "c51c6bc3979929f03f4f65ca75569d9f6e48bbb0d8626bc9851e76bc0e40b9ea"
		)
	]
)