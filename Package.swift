...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.26.xcframework.zip",
			checksum: "8d3ae615345621d1389a80370133bb143d5eb1d64a484be9a6db2694a3314245"
		)
	]
)