...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-4.1.5.xcframework.zip",
			checksum: "555e4d4eb910bb510331f3d4d17e88d0eac87d82df4ce6e4a4744ba2f82694a3"
		)
	]
)