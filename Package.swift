...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.39.xcframework.zip",
			checksum: "732957e822c6a839e373d18e07784c189262339307657f0ebb3fff34ecc4471e"
		)
	]
)