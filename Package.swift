...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_DeviceAuthentication-3.2.0-rc.0.xcframework.zip",
			checksum: "4c9e111a48d05a1f16c38bec1dc943e11d453f749692e50523d6a5fa38e65407"
		)
	]
)