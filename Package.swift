...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.3.0-beta.7.xcframework.zip",
			checksum: "2faf8a67ec45a9522232fcff5059ccf7edeb394447dd344470b250ac69f8838d"
		)
	]
)