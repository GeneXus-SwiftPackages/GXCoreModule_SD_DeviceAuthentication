...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230724135409.xcframework.zip",
			checksum: "7cb188b965eff4c32f68731141a2e4458be63dc43ae0311232627f9665372699"
		)
	]
)