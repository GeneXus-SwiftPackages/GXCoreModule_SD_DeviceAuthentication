...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.2.0-beta.18.xcframework.zip",
			checksum: "260a1853418aab90caed81e7a9e489debc041776cfd4d1269752397a60876cea"
		)
	]
)