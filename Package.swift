...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_DeviceAuthentication-1.1.3.xcframework.zip",
			checksum: "43cb0a87210d23d18ba21db7940a54e6d41f2f116b19c93ec467a7f4779ee2ba"
		)
	]
)