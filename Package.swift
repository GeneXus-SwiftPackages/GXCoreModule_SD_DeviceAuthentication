...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.2.0-beta.20.xcframework.zip",
			checksum: "8bbbd6589a4e28a150ea7358e0dec949d6901c89d40631a801b67f8177b3a70f"
		)
	]
)