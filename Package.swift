...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.1.0-beta.9.xcframework.zip",
			checksum: "968105385f92cd2938f3bce30e48730f86229880a1e55fad08a8b3461ecb24c5"
		)
	]
)