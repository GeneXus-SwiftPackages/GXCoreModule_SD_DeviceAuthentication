...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_DeviceAuthentication-1.1.0-rc.4.xcframework.zip",
			checksum: "79a11c4ae0b22d183ee818022b5cf90d1696aaacaf85b94581ce8724e601ba1d"
		)
	]
)