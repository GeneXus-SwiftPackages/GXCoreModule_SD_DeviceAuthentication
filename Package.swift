...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.4.0-beta.14.xcframework.zip",
			checksum: "f335d10a8bc62578028c4702791a04e7a98c3791a18cd3b1997007a82bf06e88"
		)
	]
)