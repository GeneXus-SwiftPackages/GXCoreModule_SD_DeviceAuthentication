...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_DeviceAuthentication-4.2.0-rc.0.xcframework.zip",
			checksum: "e779718390c3a858e9e625a31be6ef967f8a81467feb5d975247d785387f522f"
		)
	]
)