...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.1.0-beta.7.xcframework.zip",
			checksum: "e826bf4535f4849644b1863dc61ac44d44d2abe4233dd3fac4b74aeaa9845722"
		)
	]
)