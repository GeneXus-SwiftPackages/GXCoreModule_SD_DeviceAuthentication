...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.17.xcframework.zip",
			checksum: "d2fbe0108e6916e08cfab3e668a276b069e6503fb38c4abe4d871ad7b0cead9d"
		)
	]
)