...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.5.0-beta.4.xcframework.zip",
			checksum: "821dbd890cca0c89c98d2214fc6e048aa9c16c8fc2aa9254e177688226ee1c9b"
		)
	]
)