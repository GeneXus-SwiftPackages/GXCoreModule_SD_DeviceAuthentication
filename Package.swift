...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.18.xcframework.zip",
			checksum: "99a2a07985e6e16230709846547a0628c9664731a8f2ab1fe693b87b771cc983"
		)
	]
)