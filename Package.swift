...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.5.0-beta.28.xcframework.zip",
			checksum: "5dfb92149d1f05db2990ac7377b228a576d98a1d6ff78f80447046fe9b7a1bc9"
		)
	]
)