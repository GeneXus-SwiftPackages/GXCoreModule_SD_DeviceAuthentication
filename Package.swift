...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.0.0-beta.20230721123914.xcframework.zip",
			checksum: "775fa3901a8292390fe789d2537ad6f2c963a48d3a0dd0d6a648feed132d841c"
		)
	]
)