...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-3.0.0-beta.14.xcframework.zip",
			checksum: "35cfbb36679ed873e076c6896608137392ea90a23fe9bbc3442138c0b4174c49"
		)
	]
)