...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-2.0.0-beta.20.xcframework.zip",
			checksum: "c7cc2b9ce1bc1062018615a8deedff5dae15ee68aaeab1a0fb6d8484cd79dfdf"
		)
	]
)