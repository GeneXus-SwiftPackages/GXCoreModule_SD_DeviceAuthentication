...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_DeviceAuthentication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_DeviceAuthentication-1.2.0-beta.19.xcframework.zip",
			checksum: "69f381d8d76f8332ef2b6f509d916554efad14f96e7c72ebbe257e9a622e886a"
		)
	]
)